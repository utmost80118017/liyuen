<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse in">
        ...
        <li  style="display:none;" @if($active=="地產動態")   class="active" @endif ><a href="/posts">地產動態</a></li>

        <li  @if($active=="rates")  class="active" @endif ><a href="/rates">最新消息</a></li>
        ...
        <li style="display:none;"  @if($active=="生活美學")   class="active" @endif ><a href="/decos">生活美學</a></li>
        <li style="display:none;"  @if($active=="apeople")   class="active" @endif ><a href="/apeople">人物觀點</a></li>
        <li style="display:none;"  @if($active=="關於米築")   class="active" @endif ><a href="/post/7?category_id=24">關於米築</a></li>
